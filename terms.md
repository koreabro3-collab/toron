...
- __Country/State__ refers to:  Kazakhstan
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to bot.py.
...
- __Website__ refers to bot.py, accessible from [bot.py.ru](bot.py.ru)
